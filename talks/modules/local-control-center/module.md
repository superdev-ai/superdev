<!-- superdev:generated source=MOD-0009 revision=2942 hash=f2bbfbc7ba88d04b5996a531429cff6d9ef0f960cc4ee4b0c0539f4aa31976b0 -->
...
| Invalid Input | parseHash falls back to the default view (overview) when the hash names a view not in the VIEWS list, and rewrites the address bar to the normalized hash rather than leaving a broken-looking URL; task.update is refused with E_INVALID_PAYLOAD when the edit form submits no changed fields at all | Drill down between related records, Manage tasks in the control center |
