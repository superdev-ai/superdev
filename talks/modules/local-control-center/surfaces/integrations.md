...
|---|---|---|---|---|---|---|
| - | Integrations | page | Required area of the control center. Listed as a required area with no further content specified. Also appears as one of the entity types on the Blueprint canvas. | - | none | none |
